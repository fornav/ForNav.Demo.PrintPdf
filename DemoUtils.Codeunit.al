codeunit 50150 "Demo Utils"
{
    ...
    begin
        ...
        if (not LocalPrinter.Get(directPrinterName)) then begin
            LocalPrinter.Init();
            LocalPrinter."Cloud Printer Name" := CopyStr(directPrinterName, 1, MaxStrLen(LocalPrinter."Cloud Printer Name"));
            LocalPrinter."Local Printer Name" := CopyStr(LocalPrinterName, 1, MaxStrLen(LocalPrinter."Local Printer Name"));
